    ...
    <div class="lower-text column-wrapper">
      <div class="advisor col-2 loeb">
        <div class="icon-wrapper">
          <a href="http://www.loebenterprises.com" target="_blank">
      ...
      <div class="advisor col-2 pegasus">
        <div class="icon-wrapper">
          <a href="http://www.pcalp.com" target="_blank">
            <img src="<?php echo linkbee_uri() ?>assets/images/advisors/pegasus.png" alt="">
          </a>
        </div>
        <div class="text-wrapper">
          <h4><a href="http://www.pcalp.com" target="_blank">Pegasus Capital Advisors</a></h4>
